...
import ParsedCommand from './commands/parsers/ParsedCommand';
...
export default class InputController {
    ...
    processAircraftCommand() {
        ...
        // Using try/catch here very much on purpose. the `ParsedCommand` will throw when it encounters any kind
        ...
        try {
            parsedCommand = new ParsedCommand(userCommand);
        } catch (error) {
        ...
        switch (parsedCommand.command) {
            ...
            case PARSED_COMMAND_NAME.TIMEWARP:
                ...
                if (parsedCommand.args) {
                    nextTimewarpValue = parsedCommand.args[0];
                }
